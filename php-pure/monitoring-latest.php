...
<html lang="es">
  <head>
    ...
    <title>Latest - Humidity and temperature example</title>
  </head>
  <body>
    <div class="container text-center">
      <h4>Último paquete de datos del dispositivo <?php echo $mac; ?></h4>
      <div class="text-left">
          <form style="display:inline;" method="post" action="monitoring-menu.php">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6 text-center">
                  <h3>Humedad</h3>
                  <h4><?php echo $data['humidity'];?></h4>
                </div>
                <div class="col-md-6 text-center">
                  <h3>Temperatura</h3>
                  <h4><?php echo $data['temperature'];?></h4>
                </div>
              </div>
            </div>
          </div>
